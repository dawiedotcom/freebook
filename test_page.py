...
<body> 
<p class="warning"> 
<A HREF="index.html"><IMG TITLE="Programming in Lua (first edition)" SRC="capa.jpg" ALT="" ALIGN="left"></A>This first edition was written for Lua 5.0. While still largely relevant for Lua 5.1, there are some <A HREF="../manual/5.1/manual.html#7">differences</A>.<BR>The second edition targets Lua 5.1 and is available at <A HREF="http://www.amazon.com/exec/obidos/ASIN/8590379825/theprogrammil3-20">Amazon</A> and as an <A HREF="http://store.feistyduck.com/products/programming-in-lua">e-book</A>.<BR>By buying the book, you also help to <A HREF="../donations.html">support the Lua project</A>.
</p> 
...
preface_no_header = '''<p><h1>Preface</h1> 
...
preface_no_header_footer = '''<p><h1>Preface</h1> 
